...
import { Plus, Trash2, Edit2, Ticket, Hash, ChevronRight, ShieldOff } from "lucide-react";
...
export default function Tickets() {
  ...
  const [panelDraft, setPanelDraft] = useState<any>({ name: "", description: "", emoji: "🎫", supportRoleIds: [], panelChannelId: "", openMessage: "" });
  ...
  const openCreatePanel = () => {
    setPanelDraft({ name: "", description: "", emoji: "🎫", supportRoleIds: [], panelChannelId: "", openMessage: "" });
    setPanelModal({ open: true });
  };

  const openEditPanel = (panel: any) => {
    setPanelDraft({ openMessage: "", ...panel });
