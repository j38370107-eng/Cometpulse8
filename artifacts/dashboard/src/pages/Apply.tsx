    ...
    <div style={{ minHeight: "100vh", background: "#0f1117", display: "flex", alignItems: "center", justifyContent: "center", padding: "32px 16px" }}>
      <div style={{ width: "100%", maxWidth: 580 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 11, color: "#64748b", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 4 }}>Application Form</div>
        </div>
        ...
        {me && me !== "loading" && form && !submitted && (
          <div style={{ background: "#161824", border: "1px solid #2e3148", borderRadius: 14, padding: "28px 32px" }}>
            <h1 style={{ fontSize: 22, fontWeight: 800, color: "#e2e8f0", marginBottom: form.description ? 8 : 24 }}>{form.title}</h1>
            {form.description && (
              <p style={{ fontSize: 14, color: "#94a3b8", marginBottom: 24, lineHeight: 1.6 }}>{form.description}</p>
            )}
