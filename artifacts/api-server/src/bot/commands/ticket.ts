...
export const ticketCommand: Command = {
  ...
  async execute(message: Message, args: string[]) {
    ...
    return message.reply("❌ The `>ticket` command is disabled. Ticket panels and settings are managed from the **dashboard** — use your server's dashboard to set up and configure tickets.");
