...
- [Music + voice deps](music-voice-deps.md) — streaming switched to yt-dlp binary (bin/yt-dlp); play-dl/ytdl-core both broken by YouTube API changes; yt-dlp spawned as subprocess for WebmOpus stream
